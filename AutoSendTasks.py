...
class UserInput(Node):
    ...
    def __init__(self, numOfBots, taskOrderType, experimentRunTime, experimentAddressType, maxWaitTime):
    ...
    def publishInput(self):
        ...
        while(True):
            ...
            interruption = f"interruption server {robot} {urgency} {priority} {self.InterruptID} wait 3 2"
...
def main():
    ...
    userInputNode = UserInput(numOfBots=args.numOfBots, taskOrderType=args.task_order_type, experimentRunTime=args.experiment_run_time, experimentAddressType=args.experiment_address_type, maxWaitTime=args.max_wait_time)
